...
import { User, Mail, BookOpen, Briefcase, Award, Edit3, X, Check, Upload, Image as ImageIcon, FileText, RefreshCw } from 'lucide-react';
      ...
      <div className="space-y-8">
        <div className="bg-white dark:bg-neon-dark rounded-3xl shadow-sm border border-gray-100 dark:border-neon-teal overflow-hidden transition-colors duration-300">
          ...
          <div className="px-8 pb-8">
            ...
            <div className="mt-12 p-8 bg-indigo-50/50 dark:bg-neon-gray/30 border border-indigo-100 dark:border-neon-teal/20 rounded-3xl">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  <div className="p-4 bg-indigo-600 dark:bg-neon-teal rounded-2xl text-white dark:text-neon-dark">
                    <FileText className="h-8 w-8" />
                  </div>
                  <div>
                    <h5 className="font-bold text-gray-900 dark:text-neon-cyan text-lg">AI Resume Parser</h5>
                    <p className="text-gray-500 dark:text-neon-light text-sm">Upload your resume to automatically fill your profile and skills.</p>
                  </div>
                </div>
                
                <label className={`
                  flex items-center gap-3 px-8 py-4 rounded-2xl font-bold transition-all cursor-pointer
                  ${isParsing 
                    ? 'bg-gray-200 dark:bg-gray-700 text-gray-500 cursor-not-allowed' 
                    : 'bg-indigo-600 hover:bg-indigo-700 dark:bg-neon-teal dark:hover:bg-neon-teal/80 text-white dark:text-neon-dark shadow-lg hover:shadow-xl hover:-translate-y-1'}
                `}>
                  {isParsing ? (
                    <>
